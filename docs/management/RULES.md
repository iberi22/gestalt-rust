...
1. **Siempre leer `docs/architecture/PLANNING.md`** para entender la arquitectura, objetivos y restricciones del proyecto.
2. **Consultar `.github/issues/MVP_Status.md`** antes de comenzar cualquier trabajo. Si la tarea no está listada, añadirla con descripción breve y fecha.
3. **Usar convenciones de nombres, estructura de archivos y patrones de arquitectura** descritos en `docs/architecture/PLANNING.md`.
